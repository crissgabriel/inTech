...
function wp_bootstrap_starter_scripts() {
    ...
    // load lightslider
    wp_enqueue_style( 'lightslider-css', get_template_directory_uri() . '/inc/assets/css/lightslider.css' );    
    // fontawesome cdn
    ...
    // load lightslider js
    wp_enqueue_script('wp-bootstrap-starter-lightslider', get_template_directory_uri() . '/inc/assets/js/lightslider.js', array(), '', true );
	// load bootstrap js
    wp_enqueue_script('wp-bootstrap-starter-popper', get_template_directory_uri() . '/inc/assets/js/popper.min.js', array(), '', true );
