...
function wp_bootstrap_starter_setup() {
	...
	register_nav_menus( array(
        ...
        'footer' => __( 'Footer' ),
        'footer-social' => __( 'Social Media Footer' ),
	) );
...
function wp_bootstrap_starter_scripts() {
    ...
    wp_enqueue_style( 'slick-lightbox-css', get_template_directory_uri() . '/inc/assets/css/slick-lightbox.css'); 
    wp_enqueue_style( 'slick-theme-css', get_template_directory_uri() . '/inc/assets/css/slick-theme.css');       
    // fontawesome cdn

    wp_enqueue_style( 'wp-bootstrap-pro-fontawesome-cdn', 'https://use.fontawesome.com/releases/v5.2.0/css/all.css' );
	// load bootstrap css
	// load AItheme styles
    ...
    if(get_theme_mod( 'preset_style_setting' ) === 'opensans') {
        wp_enqueue_style( 'wp-bootstrap-starter-opensans-font', 'https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,800' );
    }
    ...
    //popper js
    wp_enqueue_script('wp-bootstrap-starter-popper', get_template_directory_uri() . '/inc/assets/js/popper.js', array(), '', true );
    wp_enqueue_script('wp-bootstrap-starter-popper', get_template_directory_uri() . '/inc/assets/js/popper.min.js', array(), '', true );

    // load slick js
    wp_enqueue_script('wp-bootstrap-starter-slick', get_template_directory_uri() . '/inc/assets/js/slick.js', array(), '', true );
    wp_enqueue_script('wp-bootstrap-starter-slick-0', get_template_directory_uri() . '/inc/assets/js/slick.min.js', array(), '', true );
    wp_enqueue_script('wp-bootstrap-starter-slick-1', get_template_directory_uri() . '/inc/assets/js/slick-lightbox.js', array(), '', true );
    wp_enqueue_script('wp-bootstrap-starter-slick-2', get_template_directory_uri() . '/inc/assets/js/slick-lightbox.min.js', array(), '', true );
